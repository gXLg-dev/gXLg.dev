...
Dmitry Plesunov
gXLg.dev, Selbstständige Softwareentwicklung
Jedelstetten 24, 82269 Geltendorf, Deutschland
`;
...
<tr>
  <td style="color: #422d23; font-size: 12px">
    Dmitry Plesunov
    <br>
    gXLg.dev, {{email.self}}
    <br>
    Jedelstetten 24, 82269 Geltendorf, {{email.germany}}
  </td>
</tr>
</table>
</body>`;
